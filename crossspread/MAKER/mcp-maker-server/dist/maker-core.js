    ...
    redFlagPatterns: [
        {
            ...
            pattern: (r) => r.length > 3000, // ~750 tokens
            severity: 'high',
        },
        {
 ...
 */
export function calculateKMin(totalSteps, perStepSuccessRate, targetProbability = 0.95, stepsPerSubtask = 1 // m=1 for maximal decomposition
) {
 ...
 */
export function calculateCorrectSelectionProbability(perStepSuccessRate, k) {
    const p = perStepSuccessRate;
 ...
 */
export function calculateFullTaskSuccessProbability(totalSteps, perStepSuccessRate, k, stepsPerSubtask = 1) {
    const p = perStepSuccessRate;
 ...
 */
export function detectRedFlags(response, config = DEFAULT_CONFIG) {
...
function getRedFlagDescription(type) {
    const descriptions = {
 ...
 */
export function createVote(subtaskId, response, config = DEFAULT_CONFIG) {
 ...
 */
export function hashResponse(response) {
 ...
 */
export function createVotingSession(subtaskId) {
    return {
        subtaskId,
        votes: new Map(),
        responses: [],
 ...
 */
export function addVoteToSession(session, vote, k) {
...
function getDecompositionStrategy(complexity) {
    const strategies = {
 ...
 */
export function suggestDecomposition(taskDescription) {
    const suggestions = [];
 ...
 */
export function formatSubtaskPrompt(subtask) {
 ...
 */
export function calculateStats(task) {
 ...
 */
export function generateSubtaskId(taskId, index) {
    return `${taskId}-step-${index.toString().padStart(4, '0')}`;
}
//# sourceMappingURL=maker-core.js.map