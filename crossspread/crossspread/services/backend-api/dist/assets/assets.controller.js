...
let AssetsController = class AssetsController {
    ...
    async getExchangeAssets(exchange) {
    ...
    async getAssetAcrossExchanges(asset) {
        return this.assetsService.getAssetInfoByAsset(asset);
    }
    async getAssetOnExchange(exchange, asset) {
        const exchangeInfo = await this.assetsService.getAssetInfo(exchange);
        if (!exchangeInfo) {
            return { error: `No asset info found for exchange: ${exchange}` };
        }
        const assetInfo = exchangeInfo.assets.find((a) => a.asset.toUpperCase() === asset.toUpperCase());
        if (!assetInfo) {
...
__decorate([
    (0, common_1.Get)('exchange/:exchange'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    __param(0, (0, common_1.Param)('exchange')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AssetsController.prototype, "getExchangeAssets", null);
__decorate([
    (0, common_1.Get)('asset/:asset'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    __param(0, (0, common_1.Param)('asset')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AssetsController.prototype, "getAssetAcrossExchanges", null);
__decorate([
    (0, common_1.Get)(':exchange/:asset'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    __param(0, (0, common_1.Param)('exchange')),
    ...
    __metadata("design:returntype", Promise)
], AssetsController.prototype, "getAssetOnExchange", null);
